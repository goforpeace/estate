...
import { Building2, LayoutDashboard, Users, Waypoints, HandCoins, Settings, LogOut } from "lucide-react"
...
const navItems = [
    ...
    { href: "/payments", icon: "CreditCard", label: "Payments" }, // Using string for example
